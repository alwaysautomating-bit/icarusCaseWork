...
- Deterministic structure: **8 witness blocks**, no overlaps or invalid blocks
- Mapped acceptance windows: **2 testimony units, 2 knowledge items, 2 claims, 2 event candidates, 2 temporal assertions**
...
- Persistence: **complete and idempotent** through `commit_testimony_knowledge_map`
